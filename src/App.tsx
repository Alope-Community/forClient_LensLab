...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#141517] text-white font-inter selection:bg-primary/30 pb-12">
      <Navbar />
      ...
      <main className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-8 space-y-4">
            <div className="relative w-full aspect-square md:aspect-[4/3] rounded-sm overflow-hidden border border-white/5 bg-[#1a1c1f]">
              <img 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-[#1A1C1F] border border-white/5 rounded-lg p-4">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <div className="bg-[#1A1C1F] border border-white/5 rounded-lg p-6">
              ...
              <div className="mt-8 pt-6 border-t border-white/5">
                <button className="w-full bg-[#B2EBF2] hover:bg-[#80D8E5] text-[#141517] font-inter font-medium text-sm py-3.5 rounded-md transition-all hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-2">
